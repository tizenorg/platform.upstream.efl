...
Name:           efl
Version:        da3f60546314bbb5d91d9fa8668acc0a0c348bf8
Release:        0
License:        LGPL-2.1
...
Summary:  Examples for eet
Group:    Graphics & UI Framework/Testing
Requires: eet = %{version}-%{release}

%description -n eet-examples
Example files for the eet package

%package -n eet-devel
Summary:  Development components for eet
Group:    Graphics & UI Framework/Development
Requires: eet = %{version}-%{release}

%description -n eet-devel
Development files for the eet package
...
Summary:  Examples for eo
Group:    Graphics & UI Framework/Testing
Requires: eo = %{version}-%{release}

%description -n eo-examples
Example files for the eo package

%package -n eo-devel
Summary:  Development components for eo
Group:    Graphics & UI Framework/Development
Requires: eo = %{version}-%{release}

%description -n eo-devel
Development files for the eo package
...
Summary:  Examples for evas
Group:    Graphics & UI Framework/Testing
Requires: evas = %{version}-%{release}

%description -n evas-examples
Example files for the evas package

%package -n evas-devel
Summary:  Development components for evas
Group:    Graphics & UI Framework/Development
Requires: evas = %{version}-%{release}

%description -n evas-devel
Development files for the evas package
...
Summary:  Examples for ecore
Group:    Graphics & UI Framework/Testing
Requires: ecore = %{version}-%{release}

%description -n ecore-examples
Example files for the ecore package

%package -n ecore-devel
Summary:  Development components for ecore
Group:    Graphics & UI Framework/Development
Requires: ecore = %{version}-%{release}

%description -n ecore-devel
Development files for the ecore package
...
Summary:  Examples for eldbus
Group:    Graphics & UI Framework/Testing
Requires: eldbus = %{version}-%{release}

%description -n eldbus-examples
Example files for the eldbus package

%package -n eldbus-devel
Summary:  Development components for eldbus
Group:    Graphics & UI Framework/Development
Requires: eldbus = %{version}-%{release}

%description -n eldbus-devel
Development files for the eldbus package

############ Elocation
%package -n elocation
Summary:  A convenience library to ease application developers the usage of geo information in their apps.
Requires: %{name}-data = %{version}-%{release}

%description -n elocation
A convenience library to ease application developers the usage of geo
 information in their apps.

Adding a geo tag to a picture or translating an address to a GPS position and show it on a map widget are just some of the use cases.In the beginning elocation will rely on the GeoClue1 DBus service. Supporting the new GeoClue2 DBus service is planned and worked on.

%package -n elocation-examples
Summary:  Examples for elocation
Group:    Graphics & UI Framework/Testing
Requires: elocation = %{version}-%{release}

%description -n elocation-examples
Example files for the elocation package

%package -n elocation-devel
Summary:  Development components for elocation
Group:    Graphics & UI Framework/Development
Requires: elocation = %{version}-%{release}

%description -n elocation-devel
Development files for the elocation package
...
Summary:  Development components for embryo
Group:    Graphics & UI Framework/Development
Requires: embryo = %{version}-%{release}

%description -n embryo-devel
Development files for the embryo package
...
Summary:  Examples for eio
Group:    Graphics & UI Framework/Testing
Requires: eio = %{version}-%{release}

%description -n eio-examples
Example files for the eio package

%package -n eio-devel
Summary:  Development components for eio
Group:    Graphics & UI Framework/Development
Requires: eio = %{version}-%{release}

%description -n eio-devel
Development files for the eio package
...
Summary:  Development components for ephysics
Group:    Graphics & UI Framework/Development
Requires: ephysics = %{version}-%{release}

%description -n ephysics-devel
Development files for the ephysics package
...
Summary:  Examples for edje
Group:    Graphics & UI Framework/Testing
Requires: edje = %{version}-%{release}

%description -n edje-examples
Example files for the edje package

%package -n edje-devel
Summary:  Development components for edje
Group:    Graphics & UI Framework/Development
Requires: edje-tools = %{version}-%{release}

%description -n edje-devel
Development files for the edje package
...
Summary:  Development components for eeze
Group:    Graphics & UI Framework/Development
Requires: eeze = %{version}-%{release}

%description -n eeze-devel
Development files for the eeze package
...
Summary:  Development components for efreet
Group:    Graphics & UI Framework/Development
Requires: efreet = %{version}-%{release}

%description -n efreet-devel
Development files for the efreet package
...
Summary:  Examples for emotion
Group:    Graphics & UI Framework/Testing
Requires: emotion = %{version}-%{release}

%description -n emotion-examples
Example files for the emotion package

%package -n emotion-devel
Summary:  Development components for emotion
Group:    Graphics & UI Framework/Development
Requires: emotion = %{version}-%{release}

%description -n emotion-devel
Development files for the emotion package
...
Summary:  Development components for ethumb
Group:    Graphics & UI Framework/Development
Requires: ethumb = %{version}-%{release}

%description -n ethumb-devel
Development files for the ethumb package
...
Summary: Development components for eolian
Group:    Graphics & UI Framework/Development
Requires: eolian = %{version}-%{release}

%description -n eolian-devel
Development files for the eolian package

%package -n eolian-examples
Summary:  Examples for eolian
Group:    Graphics & UI Framework/Testing
Requires: eolian = %{version}-%{release}

%description -n eolian-examples
Example files for the eolian package
