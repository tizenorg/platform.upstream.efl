...
static Eina_Bool
_simple_demo_cb_signal_exit(void *data, int type, void *event)
{
...
Ecore_Buffer         *_simple_demo_provider_buffer_get(Ecore_Buffer_Provider *provider, int w, int h, int format);
...
_simple_demo_provider_callback_set(Provider_Data *pd,
                                   ...
                                   Ecore_Buffer_Provider_Enqueue_Cb enqueued)
{
   ...
   ecore_buffer_provider_buffer_released_cb_set(pd->provider, enqueued, pd);
}
...
Ecore_Buffer *
_simple_demo_provider_buffer_get(Ecore_Buffer_Provider *provider, int w, int h, int format)
{
...
static void
_simple_demo_cb_consumer_add(Ecore_Buffer_Provider *provider, int queue_size, int w, int h, void *data)
{
   Provider_Data *pd = (Provider_Data *)data;
...
static void
_simple_demo_cb_consumer_del(Ecore_Buffer_Provider *provider, void *data)
{
...
static void
_simple_demo_cb_provider_enqueued(Ecore_Buffer_Provider *provider, void *data)
{
   Provider_Data *pd = (Provider_Data *)data;
...
static void
_simple_demo_cb_consumer_enqueued(Ecore_Buffer_Consumer *consumer, void *data)
{
   Consumer_Data *cd = (Consumer_Data *)data;
...
main(int argc, char *argv[])
{
   ...
   _simple_demo_provider_callback_set(pd,
                                      ...
                                      _simple_demo_cb_provider_enqueued);
