...
Queue       *_queue_new(int capacity);
void         _queue_free(Queue *queue);
void         _queue_data_remove(Queue *queue, void *data);
int          _queue_size_get(Queue *queue);
Eina_Bool    _queue_is_full(Queue *queue);
Eina_Bool    _queue_is_empty(Queue *queue);
Eina_Bool    _queue_dequeue(Queue *queue, void **ret_data);
Eina_Bool    _queue_enqueue(Queue *queue, void *data);
