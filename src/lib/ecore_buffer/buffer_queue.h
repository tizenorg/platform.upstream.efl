...
Eina_Bool            _ecore_buffer_queue_dequeue(Ecore_Buffer_Queue *ebq,
                                                 Shared_Buffer **ret_sb);
Eina_Bool            _ecore_buffer_queue_is_empty(Ecore_Buffer_Queue *ebq);
void                 _ecore_buffer_queue_shared_buffer_add(Ecore_Buffer_Queue *ebq,
                                                           Shared_Buffer *sb);
void                 _ecore_buffer_queue_shared_buffer_remove(Ecore_Buffer_Queue *ebq,
                                                              Shared_Buffer *sb);
Eina_List           *_ecore_buffer_queue_shared_buffer_list_get(Ecore_Buffer_Queue *ebq);
void                 _ecore_buffer_queue_connection_state_set(Ecore_Buffer_Queue *ebq,
                                                              Eina_Bool connect);
