...
// TIZEN_ONLY(20150112): Add missing Tizen Only ECORE_X_ATOM_*.
...
EAPI Ecore_X_Atom ECORE_X_ATOM_E_WINDOW_AUX_HINT_RESET_REQUEST= 0;
...
const Atom_Item atom_items[] =
{
   ...
   { "_E_VIRTUAL_KEYBOARD_OFF_PREPARE_DONE", &ECORE_X_ATOM_E_VIRTUAL_KEYBOARD_OFF_PREPARE_DONE },
   { "_E_KEYROUTER_SUPPORTED", &ECORE_X_ATOM_E_KEYROUTER_SUPPORTED },
//this string should be changed after keyrouter changed
// { "_E_KEYROUTER_WINDOW_KEYTABLE", &ECORE_X_ATOM_E_KEYROUTER_WINDOW_KEYTABLE }
   { "_GRAB_KEY", &ECORE_X_ATOM_E_KEYROUTER_WINDOW_KEYTABLE }
};
