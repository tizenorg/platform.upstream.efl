 ...
 *
 * @remark This function returns #EINA_TRUE if the  given spans intersect, #EINA_FALSE
 * otherwise.
 */
 ...
 *
 * @remark This function returns #EINA_TRUE if @p r is empty, #EINA_FALSE
 ...
 *
 * @remark This function sets its top-left x coordinate to @p x, its top-left
 ...
 *
 * @remark This function returns #EINA_TRUE if @p r1 and @p r2 intersect, #EINA_FALSE
 ...
 * @return #EINA_TRUE on success, #EINA_FALSE otherwise.
 *
 * @remark This function returns #EINA_TRUE if @p x is in @p r with respect to
 ...
 * @return #EINA_TRUE on success, #EINA_FALSE otherwise.
 *
 * @remark This function returns #EINA_TRUE if @p y is in @p r with respect to
 ...
 * @return #EINA_TRUE on success, #EINA_FALSE otherwise.
 *
 * @remark This function returns #EINA_TRUE if the point of coordinate (@p x,
 ...
 *
 * @remark This function get the union of the rectangles @p dst and @p src. The
 ...
 * otherwise.
 *
 * @remark This function get the intersection of the rectangles @p dst and
 ...
 * @param[out] res The resulting rectangle.
 *
 */
 ...
 *
 * @remark This function adds the rectangle of size (@p width, @p height) to a
 ...
 *
 * @remark This function returns the pool in which @p rect is. If  @p rect is
 ...
 * @return #EINA_TRUE on success, #EINA_FALSE otherwise.
 *
 * @remark This function returns the width and height of @p pool and store
 ...
 *
 * @remark This function gets the data from @p pool set by
 ...
 *
 * @remark This function sets @p data to @p pool. If @p pool is @c NULL, this
 ...
 *
 * @remark This function frees the allocated data of @p pool. If @p pool is
 ...
 *
 * @remark This function returns the number of rectangles in @p pool.
 */
 ...
 *
 * @remark This function retrieve from @p pool the rectangle of width @p w and
 ...
 *
 * @remark This function removes @p rect from the pool. If @p rect is
 ...
 *
 * @remark This function creates a rectangle which top left corner has the
 ...
 *
 * @remark This function removes @p rect from the rectangles pool.
 */
 ...
 *
 * @remark This function sets @p type of @p pool.
