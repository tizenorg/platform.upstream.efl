 ...
 *
 * @remark This function creates a new string buffer. On error, @c NULL is
 ...
 *
 * @remark This function frees the memory of @p buf. @p buf must have been
 ...
 *
 * @remark This function reset @p buf: the buffer len is set to 0, and the
 ...
 *
 * @remark This function appends @p str to @p buf. It computes the length of
 ...
 * @return #EINA_TRUE on success, #EINA_FALSE on failure.
 *
 * @remark This function escapes and then appends the string @p str to @p buf. If @p str
 ...
 * @return #EINA_TRUE on success, #EINA_FALSE on failure.
 *
 * @remark This function appends at most @p maxlen characters of @p str to
 ...
 * @return #EINA_TRUE on success, #EINA_FALSE on failure.
 *
 * @remark This function appends @p str to @p buf. @p str must be of size at
 ...
 * @return #EINA_TRUE on success, #EINA_FALSE on failure.
 *
 * @remark This function inserts @p c to @p buf. If it can not insert it, #EINA_FALSE
 ...
 * @return #EINA_TRUE on success, #EINA_FALSE on failure.
 *
 * @remark This function appends the string defined by the format @p fmt to @p buf. @p
 ...
 * @return #EINA_TRUE on success, #EINA_FALSE on failure.
 *
 * @remark This function inserts @p str to @p buf at position @p pos. It
 ...
 * @return #EINA_TRUE on success, #EINA_FALSE on failure.
 *
 * @remark This function escapes and inserts the string @p str to @p buf at
 ...
 * @return #EINA_TRUE on success, #EINA_FALSE on failure.
 *
 * @remark This function inserts @p str to @p buf at position @p pos, with at
 ...
 * @return #EINA_TRUE on success, #EINA_FALSE on failure.
 *
 * @remark This function inserts @p str to @p buf. @p str must be of size at
 ...
 * @return #EINA_TRUE on success, #EINA_FALSE on failure.
 *
 * @remark This function inserts @p c to @p buf at position @p pos. If @p buf
 * can't append it, #EINA_FALSE is returned, otherwise #EINA_TRUE is
 * returned.
 */
 ...
 * @return #EINA_TRUE on success, #EINA_FALSE on failure.
 *
 * @remark This function insert a string as described by the format @p fmt to @p buf at
 ...
 * @return #EINA_TRUE on success, #EINA_FALSE on failure.
 *
 * @remark This function removes a slice of @p buf, starting at @p start
 ...
 *
 * @remark This function returns the string contained in @p buf. The returned
 ...
 * @return The current string in the string buffer.
 *
 * @remark This function returns the string contained in @p buf. @p buf is
 ...
 *
 * @remark This function frees the string contained in @p buf without freeing
 * @p buf.
 */
 ...
 *
 * @remark This function returns the length of @p buf.
 */
 ...
 * @param[in] with The replaceing string.
 * @param[in] n The number of the fitting string.
 * @return #EINA_TRUE on success, #EINA_FALSE on failure.
 *
 * @remark This function replaces the n-th occurrence of @p str in @p buf with
 ...
 *
 * @remark This function replaces all the occurrences of @p str in @p buf with
 ...
 * @param[in] buf the string buffer to work with.
 *
 * @remark This function skips whitespaces in the beginning and the end of the buffer.
 */
 ...
 * @param[in] buf the string buffer to work with.
 *
 * @remark This function skips whitespaces in the beginning of the buffer.
 */
 ...
 * @param[in] buf the string buffer to work with.
 *
 * @remark This function skips whitespaces in the end of the buffer.
 */
