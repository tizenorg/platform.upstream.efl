...
eldbus_pending_dispatch(Eldbus_Pending *pending, Eldbus_Message *msg)
{
   ...
   if (pending->dbus_pending) // TIZEN ONLY (20150921): Add NULL check to avoid crash in dbus
